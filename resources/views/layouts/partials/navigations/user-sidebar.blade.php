<nav id="sidebar" class="px-0 bg-dark bg-gradient sidebar">
    <ul class="nav nav-pills flex-column">
        ...
        @if (Auth::user()->status === 'Active')
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('users.dashboard') ? 'active' : ''}}" href="/users/dashboard">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="/users/training-content/forex" class="nav-link {{ Route::is('users.trading-content') ? 'active' : ''}}" >
                        <i class="batch-icon batch-icon-transfer"></i>
                        Forex Training
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/users/training-content/binary" class="nav-link {{ Route::is('users.trading-content') ? 'active' : ''}}">
                        <i class="batch-icon batch-icon-tag-alt-3"></i>
                        Binary Training
                        </a>
                </li>
                <li class="nav-item">
                    <a href="/users/training-content/fiml" class="nav-link {{ Route::is('users.trading-content') ? 'active' : ''}}" >
                        <i class="batch-icon batch-icon-support-alt-2"></i>
                        FIML Training
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/users/training-content/affiliate" class="nav-link {{ Route::is('users.trading-content') ? 'active' : ''}}">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item ">
                <a href="/users/downloadable-content/pdf" class="nav-link {{ Route::is('users.downloadable-content') ? 'active' : ''}} ">
                    <i class="batch-icon batch-icon-document"></i>
                    Download pdf
                </a>
            </li>
            <li class="nav-item">
                <a href="/users/downloadable-content/robot" class="nav-link {{ Route::is('users.downloadable-content') ? 'active' : ''}}">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="/users/downloadable-content/pdf" class="nav-link {{ Route::is('users.settings') ? 'active' : ''}}">
    ...
    <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item  {{ Route::is('users/pricing') ? 'active' : ''}}">
            <a href="/users/pricing" class="nav-link">
                <i class="batch-icon batch-icon-credit-card"></i>
                Pricing <span class="sr-only"></span>
            </a>
        </li>
        <li class="nav-item">
            <a href="/logout" class="nav-link">
